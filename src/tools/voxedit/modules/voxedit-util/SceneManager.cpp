...
void SceneManager::construct() {
	...
	const core::VarDef voxEditShowPalette(cfg::VoxEditShowPalette, true, N_("Palette"), N_("Show the palette panel"));
	core::Var::registerVar(voxEditShowPalette);
	const core::VarDef voxEditShowNormalPalette(cfg::VoxEditShowNormalPalette, false, N_("Normal palette"), N_("Show the normal palette panel"));
	core::Var::registerVar(voxEditShowNormalPalette);
	const core::VarDef voxEditShowMemento(cfg::VoxEditShowMemento, true, N_("Memento"), N_("Show the memento panel"));
	core::Var::registerVar(voxEditShowMemento);
	const core::VarDef voxEditShowCamera(cfg::VoxEditShowCamera, true, N_("Camera"), N_("Show the camera panel"));
	core::Var::registerVar(voxEditShowCamera);
	const core::VarDef voxEditShowLSystem(cfg::VoxEditShowLSystem, true, N_("L-System"), N_("Show the L-System panel"));
	core::Var::registerVar(voxEditShowLSystem);
	const core::VarDef voxEditShowScript(cfg::VoxEditShowScript, true, N_("Script"), N_("Show the script panel"));
	core::Var::registerVar(voxEditShowScript);
	const core::VarDef voxEditShowNetwork(cfg::VoxEditShowNetwork, true, N_("Network"), N_("Show the network panel"));
	core::Var::registerVar(voxEditShowNetwork);
	const core::VarDef voxEditShowGameMode(cfg::VoxEditShowGameMode, true, N_("Game mode"), N_("Show the game mode panel"));
	core::Var::registerVar(voxEditShowGameMode);
	const core::VarDef voxEditShowAssets(cfg::VoxEditShowAssets, true, N_("Assets"), N_("Show the asset panels"));
	core::Var::registerVar(voxEditShowAssets);
#if USE_YOCTO
	const core::VarDef voxEditShowRender(cfg::VoxEditShowRender, true, N_("Render"), N_("Show the render panel"));
	core::Var::registerVar(voxEditShowRender);
#endif
	const core::VarDef voxEditShowAnimationSettings(cfg::VoxEditShowAnimationSettings, true, N_("Animation"), N_("Show the animation settings panel"));
	core::Var::registerVar(voxEditShowAnimationSettings);
	const core::VarDef voxEditShowAnimationTimeline(cfg::VoxEditShowAnimationTimeline, true, N_("Animation timeline"), N_("Show the animation timeline panel"));
	core::Var::registerVar(voxEditShowAnimationTimeline);
	const core::VarDef voxEditShowScene(cfg::VoxEditShowScene, true, N_("Scene"), N_("Show the scene panel"));
	core::Var::registerVar(voxEditShowScene);
	const core::VarDef voxEditShowTools(cfg::VoxEditShowTools, true, N_("Tools"), N_("Show the tools panel"));
	core::Var::registerVar(voxEditShowTools);
	const core::VarDef voxEditShowSceneSettings(cfg::VoxEditShowSceneSettings, true, N_("Scene settings"), N_("Show the scene settings panel"));
