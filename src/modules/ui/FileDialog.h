...
private:
	...
	bool quickAccessPanel(video::OpenFileMode type, const core::String &bookmarks, int height);
	void currentPathPanel(video::OpenFileMode type);
	bool buttons(core::String &entityPath, video::OpenFileMode type, bool openSelectedEntry);
	void popupNewFolder();
