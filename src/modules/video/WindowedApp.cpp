...
app::AppState WindowedApp::onConstruct() {
	...
	const core::VarDef clientDebugShadowMapCascade(cfg::ClientDebugShadowMapCascade, false, N_("Debug cascades"), _("Activate cascade shadow map debug rendering"));
	core::Var::registerVar(clientDebugShadowMapCascade);
	const core::VarDef clientGamma(cfg::ClientGamma, 1.0f, 0.1f, 4.0f, N_("Gamma"), _("Gamma correction"));
	...
	const core::VarDef renderStudioBevel(cfg::RenderStudioBevel, false, N_("Studio bevel"),
										 _("Darken voxel face rims for a beveled cube look"));
